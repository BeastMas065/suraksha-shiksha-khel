...
const mockAdminData = {
  totalUsers: 2847,
  activeUsers: 1623,
  completedDrills: 15632,
  averageXP: 856,
  schoolsRegistered: 143,
  recentActivity: [
    { school: 'गुजरात प्राथमिक विद्यालय', users: 45, completion: 78, date: '2024-01-15' },
    { school: 'श्री राम माध्यमिक विद्यालय', users: 62, completion: 85, date: '2024-01-14' },
    { school: 'सरस्वती उच्च माध्यमिक विद्यालय', users: 38, completion: 92, date: '2024-01-13' },
  ],
  regionalStats: [
    { region: 'Gujarat', users: 892, completion: 76 },
    { region: 'Maharashtra', users: 654, completion: 82 },
    { region: 'Rajasthan', users: 523, completion: 68 },
    { region: 'Madhya Pradesh', users: 445, completion: 74 },
  ],
};
    ...
    <div className="min-h-screen bg-background p-4 md:p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="shadow-card">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-primary">{mockAdminData.totalUsers.toLocaleString()}</div>
            <div className="text-sm text-muted-foreground">
              {mockAdminData.activeUsers.toLocaleString()} active this month
            </div>
            <div className="mt-2">
        ...
        <Card className="shadow-card">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-secondary">{mockAdminData.schoolsRegistered}</div>
            <div className="text-sm text-muted-foreground">Across 4 states</div>
            <div className="mt-2">
        ...
        <Card className="shadow-card">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-warning">{mockAdminData.completedDrills.toLocaleString()}</div>
        ...
        <Card className="shadow-card">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-accent">{mockAdminData.averageXP}</div>
      ...
      <Card className="shadow-card">
        ...
        <CardContent>
          <div className="space-y-4">
            {mockAdminData.regionalStats.map((region) => (
